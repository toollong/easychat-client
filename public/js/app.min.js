    ...
    $(function () {
        var t = {
            Started: {
                ...
                scrolllRun: function (e) {
                    ...
                    if (0 < o.length)
                        if (1200 <= $(window)
                            ...
                            o.scrollTop(o.get(0)
                                .scrollHeight, -1)
                                .niceScroll(t), $(".layout .content .sidebar .sidebar-body")
                                    .niceScroll(t), e && (o.scrollTop(o.get(0)
                                        .scrollHeight, -1)
                                        .getNiceScroll()
                                        .resize(), $(".layout .content .sidebar .sidebar-body")
                                            .getNiceScroll()
                                            .resize())
                        } else o.scrollTop(o.get(0)
                            .scrollHeight, -1)
                },
                ...
                init: function () {
                    this.pageLoadingClose(), this.scrolllRun(), this.mobileBrowserVhProblemFixed(), $("body")
                        .hasClass("rtl") && $(".dropdown-menu.dropdown-menu-right")
                            .removeClass("dropdown-menu-right"), feather.replace(), $(window)
                                .width() < 768 && ($("body")
                                    .addClass("no-blur-effect"), $(".layout .content .sidebar-group .sidebar .list-group-item .users-list-body .users-list-action")
        ...
        $('[data-toggle="tooltip"]').tooltip(),
            ...
            $(document)
                .on("click", ".dark-light-switcher", function () {
                    return $(this).tooltip("dispose"),
                        $("body").hasClass("dark") ?
                            ($("body").removeClass("dark"), $(this).attr("title", "Dark mode")) :
                            ($("body").addClass("dark"), $(this).attr("title", "Light mode")),
                        $(this).tooltip(), !1
                }),
            $(document)
                .on("click", ".mobile-navigation-button", function () {
                    return $("body").addClass("navigation-open"), !1
                }),
            $(document)
                .on("click", "body.navigation-open", function () {
            ...
            $(document)
                .on("click", "[data-navigation-target]", function () {
            ...
            $(document)
                .on("click", ".sidebar-close", function (e) {
                    $(window).width() < 1200 ?
                        $(".sidebar-group").removeClass("mobile-open") :
            ...
            $(document)
                .on("click", "#pageTour button.start-tour", function () {
                    return $("#pageTour")
                        .modal("hide")
